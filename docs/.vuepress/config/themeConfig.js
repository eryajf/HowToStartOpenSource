...
module.exports = {
  ...
  repo: 'eryajf/HowToStartOpenSource', // 导航栏右侧生成Github链接
  ...
  footer: {
    ...
    copyrightInfo:
      'Eryajf | <a href="https://github.com/eryajf/HowToStartOpenSource/blob/main/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
  }
}