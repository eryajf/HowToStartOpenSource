...
<span class="token bold"><span class="token punctuation">**</span><span class="token content">填写PR内容：</span><span class="token punctuation">**</span></span>

-
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这样协作者提交 pr 的时候就会主动提示协作者尽量给当次 pr 添加一个或多个合适的 labels。</p><p>最后来看下生成的 release drafter：</p><p><img src="https://cdn.staticaly.com/gh/eryajf/tu/main/img/image_20220718_172517.png" alt="image_20220718_172517"></p><p>当你觉得可以发布一个新的版本的时候，就可以点击小铅笔按钮，对内容二次审查之后，点击发布：</p><p><img src="https://cdn.staticaly.com/gh/eryajf/tu/main/img/image_20220718_172527.png" alt="image_20220718_172527"></p><p>以上就是借助 GitHub Actions 的能力，自动给项目构建 releases 的全部内容。</p>`,12);function y(_,f){const a=i("ExternalLinkIcon");return p(),c("div",null,[u,r,d,k,n("p",null,[s("所用 Actions： "),n("a",v,[s("release-drafter"),e(a)])]),m,n("p",null,[s("配置文件中用到了 "),b,s("，我的这篇文章有详细介绍如何生成以及配置，可直接参考： "),n("a",g,[s("https://wiki.eryajf.net/pages/47a507/"),e(a)])]),h])}const T=l(o,[["render",y],["__file","03-Automatically-and-elegantly-build-Releases-for-the-project.html.vue"]]);export{T as default};
