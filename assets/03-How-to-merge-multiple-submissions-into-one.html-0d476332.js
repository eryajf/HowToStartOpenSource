...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>此时再去到 eryajf 主视角看刚刚那次 PR，就可以看到提交次数只有一次了：</p><p><img src="https://cdn.jsdelivr.net/gh/eryajf/tu/img/image_20220718_172134.png" alt="image_20220718_172134"></p><p>当然，这里主要是为了体验整个压缩提交的流程，实际上开发过程中，并不需要这步操作，项目的 owner 在处理 PR 的时候可以直接选择压缩合并，也就不会将多次提交合并上去了。</p>`,25)]))}const o=s(l,[["render",t],["__file","03-How-to-merge-multiple-submissions-into-one.html.vue"]]);export{o as default};
