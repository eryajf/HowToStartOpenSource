import{_ as i,r as l,o as c,c as o,a as s,b as e,d as t,e as p}from"./app-6e4b3321.js";const u={},r={href:"https://github.com/eryajf/Thanks-Mirror",target:"_blank",rel:"noopener noreferrer"},d={href:"https://github.com/lycheeverse/lychee",target:"_blank",rel:"noopener noreferrer"};function m(k,n){const a=l("ExternalLinkIcon");return c(),o("div",null,[n[8]||(n[8]=s("h2",{id:"preface",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#preface","aria-hidden":"true"},"#"),e(" Preface")],-1)),s("p",null,[n[1]||(n[1]=e("Open source projects that I maintain ")),s("a",r,[n[0]||(n[0]=e("Thanks-Mirror")),t(a)]),n[2]||(n[2]=e(" Collated and recorded various package managers, system images, and useful images of common software, as the project became more and more perfect, to today, has accumulated 1091 links, over time, some domestic mirrors may stop maintenance, how to customize the perception of those links that have failed, is a matter to consider."))]),n[9]||(n[9]=s("p",null,"This article introduces an interesting little action, its main function is to automatically scan the links in the repository, and then request the links, according to the custom rules, automatically throw abnormal links, and then create these links into the issue.",-1)),n[10]||(n[10]=s("h2",{id:"disposition",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#disposition","aria-hidden":"true"},"#"),e(" Disposition")],-1)),s("p",null,[n[4]||(n[4]=e("Used Actions：")),n[5]||(n[5]=s("a",{href:"lycheeverse/lychee-action"},"lycheeverse/lychee-action",-1)),n[6]||(n[6]=e(" The use of configuration is actually very simple, basically after reading the official introduction document can be used to use, but the official document introduction method is not very flexible, the official is with the help of its open source project：")),s("a",d,[n[3]||(n[3]=e("lychee")),t(a)]),n[7]||(n[7]=e("To complete the check, this article will extend the configuration file for this open source project to achieve richer capabilities."))]),n[11]||(n[11]=p(`<p>Start by adding the Actions profile，e.g. <code>.github/workflows/links-check.yml</code>：</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">name</span><span class="token punctuation">:</span> 🔗 检查链接
