...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>此时项目在本地就将此次 PR 后的最新代码，以 eryajf_test 分支存在，我们可以对协作者提交的代码功能进行一些核验等工作，当我们测验感觉没有问题之后，就可以将代码进行合并了。合并的操作与上边一样，不再赘述。</p>`,29),t=[l];function c(d,p){return e(),s("div",null,t)}const o=n(i,[["render",c],["__file","03-collaborative-development-process.html.vue"]]);export{o as default};
