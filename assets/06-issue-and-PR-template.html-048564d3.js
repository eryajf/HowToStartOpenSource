...
-
-
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这样每当有协作者提交 pr，都需要提前知晓一些预置信息，以及一些可能的情况。</p>`,15);function f(q,y){const a=i("ExternalLinkIcon"),t=i("RouterLink");return o(),u("div",null,[r,v,s("ul",null,[s("li",null,[n("项目："),s("a",m,[n("github-issue-templates"),e(a)])])]),b,k,h,s("ul",null,[s("li",null,[s("a",g,[n("官方文档"),e(a)])])]),_,s("p",null,[n("还有一个很重要的点在于，鼓励协作者主动给自己的 pr 打标签分类，从而便于"),e(t,{to:"/HowToStartOpenSource/01-basic-content/pages/4abd22/"},{default:c(()=>[n("自动构建 release")]),_:1}),n("的时候根据 label 归类 pr 信息。")])])}const E=l(d,[["render",f],["__file","06-issue-and-PR-template.html.vue"]]);export{E as default};
