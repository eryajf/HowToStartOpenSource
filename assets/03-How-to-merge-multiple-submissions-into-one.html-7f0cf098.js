...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>执行之后，将会进入一个交互界面，内容如下：</p><p><img src="https://cdn.staticaly.com/gh/eryajf/tu/main/img/image_20220718_172053.png" alt="image_20220718_172053"></p><p>我们把后两个 pick 改成 squash，改后如下：</p><p><img src="https://cdn.staticaly.com/gh/eryajf/tu/main/img/image_20220718_172104.png" alt="image_20220718_172104"></p><p>这里两个关键字的含义为：</p><ul><li>pick 表示其他的提交将会合并到这一次提交上</li><li>squash 表示将对应标识的提交合并到 pick 选择的那次 commit 上。</li></ul><p>保存之后，进入一个新的交互页面，这个页面是填写提交信息的，可保持默认，然后保存，就合并成功了：</p><p><img src="https://cdn.staticaly.com/gh/eryajf/tu/main/img/image_20220718_172112.png" alt="image_20220718_172112"></p><p>通过查看状态，也能看到此时的状态详情：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>* dc38fb2 <span class="token punctuation">(</span>HEAD -<span class="token operator">&gt;</span> main<span class="token punctuation">)</span> 以lql95的视角协同维护项目
