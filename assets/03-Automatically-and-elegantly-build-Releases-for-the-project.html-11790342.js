import{_ as i,r as l,o,c,a as n,b as s,e,d as t}from"./app-61d5ee01.js";const p={},u=n("h2",{id:"preface",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#preface","aria-hidden":"true"},"#"),s(" Preface")],-1),r=n("p",null,"Projects based on git management, usually in addition to branch management, will also manage the code through tags, especially like the go language, go mods rely on tags to manage the version of the project, so reasonable version management will also be a healthier incentive for the development of the project. There is a concept of Releases in GitHub, which is actually similar to tags, and the simple understanding is to use releases to manage on the basis of hitting a tag. If you don't understand the concept here, it's still a bit difficult to successfully hit a release.",-1),d=n("p",null,"This article will show you how to build releases for your projects automatically and gracefully with Github Actions.",-1),k=n("h2",{id:"disposition",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#disposition","aria-hidden":"true"},"#"),s(" Disposition")],-1),v={href:"https://github.com/release-drafter/release-drafter",target:"_blank",rel:"noopener noreferrer"},m=t(`<p>Using the configuration is actually very simple, basically after reading the official introduction document you can get started to use, here is one or two things to pay attention to.</p><p>Start by adding the Actions profile ，e.g. <code>.github/workflows/release.yml</code>：</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">name</span><span class="token punctuation">:</span> Release Drafter
...
-
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>In this way, when the collaborator submits the PR, the collaborator will be actively prompted to try to add one or more suitable labels to the current PR.</p><p>Finally, let&#39;s look at the generated release drafter:</p><p><img src="https://cdn.jsdelivr.net/gh/eryajf/tu/img/image_20220718_172517.png" alt="image_20220718_172517"></p><p>When you feel that you can publish a new version, you can click the little pencil button, and after reviewing the content twice, click Publish:</p><p><img src="https://cdn.jsdelivr.net/gh/eryajf/tu/img/image_20220718_172527.png" alt="image_20220718_172527"></p><p>That&#39;s all for automatically building releases to a project with the help of GitHub Actions&#39; capabilities.</p>`,12);function f(y,_){const a=l("ExternalLinkIcon");return o(),c("div",null,[u,r,d,k,n("p",null,[s("Used Actions： "),n("a",v,[s("release-drafter"),e(a)])]),m,n("p",null,[h,s(" is used in the configuration file, and my article has detailed instructions on how to generate and configure, which can be directly referenced： "),n("a",b,[s("https://wiki.eryajf.net/pages/47a507/"),e(a)])]),g])}const T=i(p,[["render",f],["__file","03-Automatically-and-elegantly-build-Releases-for-the-project.html.vue"]]);export{T as default};
