...
-
-
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>In this way, whenever a collaborator submits a PR, it is necessary to know some preset information in advance, as well as some possible scenarios.</p>`,15);function y(_,w){const a=t("ExternalLinkIcon"),i=t("RouterLink");return l(),c("div",null,[p,m,s("ul",null,[s("li",null,[e("Project："),s("a",v,[e("github-issue-templates"),n(a)])])]),b,h,k,s("ul",null,[s("li",null,[s("a",g,[e("Official documentation"),n(a)])])]),f,s("p",null,[e("Another important point is to encourage collaborators to actively label and classify their PRs, so that PR information can be classified according to labels when "),n(i,{to:"/en/HowToStartOpenSource/01-basic-content/pages/4abd22/"},{default:u(()=>[e("Automatically Build Release")]),_:1})])])}const x=o(d,[["render",y],["__file","06-issue-and-PR-template.html.vue"]]);export{x as default};
