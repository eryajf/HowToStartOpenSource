...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>就是通过添加 <code>sshCommand</code> 实现不同配置中采用不同的秘钥，实测这种方案是最优雅好用的！</p>`,26)),s("ul",null,[s("li",null,[n[2]||(n[2]=a("参考： ")),s("ul",null,[s("li",null,[s("a",u,[n[0]||(n[0]=a("git config多用户配置")),i(e)])]),s("li",null,[s("a",d,[n[1]||(n[1]=a("How to tell git which private key to use?")),i(e)])])])])])])}const m=t(r,[["render",v],["__file","02-How-to-configure-multiple-GitHub-accounts-on-one-computer.html.vue"]]);export{m as default};
